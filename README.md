...
For more details explanations on Path Tracing and how the pipeline works refer to [My Master Thesis](https://leonardorodoni.ch/thesis.pdf), which was carried out at [ETH Zurich](https://ethz.ch) in the [NSG](https://nsg.ee.ethz.ch/home/) toghether with the [Swisscom](https://swisscom.com) Telemetry and Analytics Team led by Thomas Graf. 
